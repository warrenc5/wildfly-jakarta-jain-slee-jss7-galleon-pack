...
public interface SleeTransaction extends Transaction {
     ...
     * ({@link jakarta.transaction.Status#STATUS_ACTIVE Status.STATUS_ACTIVE}) or marked for rollback
     * ({@link jakarta.transaction.Status#STATUS_MARKED_ROLLBACK Status.STATUS_MARKED_ROLLBACK}).
     ...
     * {@link jakarta.transaction.Synchronization#beforeCompletion} callbacks cause it to
     ...
     * {@link jakarta.transaction.Status#STATUS_COMMITTED Status.STATUS_COMMITTED} or
     * {@link jakarta.transaction.Status#STATUS_ROLLEDBACK Status.STATUS_ROLLEDBACK}.
